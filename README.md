...
Wire the CSS + safelist once — the plugin writes a real `.css` file your CSS `@import`s:
...
export default { plugins: [tailwindcss(), fluentHtmlPlugin({ content: ["./src/**/*.ts"], theme })] };
```
```css
/* app.css */
@import "tailwindcss";
@import "./fluent-safelist.css";   /* generated by the plugin (gitignored) */
```
