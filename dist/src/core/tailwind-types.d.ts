...
export type TailwindState = "hover" | "focus" | "focus-within" | "focus-visible" | "active" | "visited" | "disabled" | "enabled" | "checked" | "indeterminate" | "required" | "invalid" | "valid" | "first" | "last" | "odd" | "even" | "empty" | "first-of-type" | "last-of-type" | "only-child" | "placeholder" | "selection" | "marker" | "file" | "before" | "after" | "dark" | "group-hover" | "group-focus" | "group-active" | "group-disabled" | "peer-hover" | "peer-focus" | "peer-checked" | "peer-invalid" | "print" | "motion-reduce" | "motion-safe" | "portrait" | "landscape" | "starting" | "open" | "inert" | `not-${string}` | `supports-[${string}]` | `nth-[${string}]`;
