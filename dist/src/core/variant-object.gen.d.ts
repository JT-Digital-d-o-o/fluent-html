import type { TailwindAlignItems, TailwindAlignSelf, TailwindAnimate, TailwindAppearance, TailwindAspect, TailwindBgBlendMode, TailwindBlur, TailwindBorderStyle, TailwindBorderWidth, TailwindBoxDecoration, TailwindBreakInside, TailwindBrightness, TailwindColSpan, TailwindColor, TailwindColumns, TailwindContent, TailwindContrast, TailwindCursor, TailwindDecorationStyle, TailwindDecorationThickness, TailwindDelay, TailwindDropShadow, TailwindDuration, TailwindEase, TailwindFlex, TailwindFlexDirection, TailwindFlexWrap, TailwindFontFamily, TailwindFontWeight, TailwindGradientAngle, TailwindGradientDirection, TailwindGradientInterpolation, TailwindGradientOrigin, TailwindGradientPosition, TailwindGradientStop, TailwindGridAuto, TailwindGridAutoFlow, TailwindGridCols, TailwindGridLine, TailwindGridRows, TailwindHeight, TailwindHueRotate, TailwindInset, TailwindInsetShadow, TailwindJustifyContent, TailwindLeading, TailwindLineClamp, TailwindListStylePosition, TailwindListStyleType, TailwindMaxHeight, TailwindMaxWidth, TailwindMinHeight, TailwindMinWidth, TailwindMixBlendMode, TailwindObjectFit, TailwindOpacity, TailwindOrder, TailwindOutline, TailwindOverflow, TailwindOverscroll, TailwindPerspective, TailwindPointerEvents, TailwindResize, TailwindRingWidth, TailwindRotate, TailwindRounded, TailwindRoundedCorner, TailwindRowSpan, TailwindSaturate, TailwindScale, TailwindScrollBehavior, TailwindSelect, TailwindShadow, TailwindSpacing, TailwindStrokeWidth, TailwindTable, TailwindTextAlign, TailwindTextShadow, TailwindTextSize, TailwindTextWrap, TailwindTracking, TailwindTransformStyle, TailwindTransition, TailwindTransitionBehavior, TailwindTranslate, TailwindTranslateZ, TailwindUnderlineOffset, TailwindWhitespace, TailwindWidth, TailwindWillChange, TailwindWrap, TailwindZIndex } from "./tailwind-types.js";
