...
test("border top", '<div class="border-t"></div>', (0, index_js_1.render)((0, index_js_1.Div)().border("t")));
test("border bottom", '<div class="border-b"></div>', (0, index_js_1.render)((0, index_js_1.Div)().border("b")));
test("border left", '<div class="border-l"></div>', (0, index_js_1.render)((0, index_js_1.Div)().border("l")));
test("border right", '<div class="border-r"></div>', (0, index_js_1.render)((0, index_js_1.Div)().border("r")));
test("border x-axis", '<div class="border-x"></div>', (0, index_js_1.render)((0, index_js_1.Div)().border("x")));
test("border y-axis", '<div class="border-y"></div>', (0, index_js_1.render)((0, index_js_1.Div)().border("y")));
test("border top (full word)", '<div class="border-t"></div>', (0, index_js_1.render)((0, index_js_1.Div)().border("top")));
test("border bottom with width", '<div class="border-b-2"></div>', (0, index_js_1.render)((0, index_js_1.Div)().border("bottom", "2")));
test("border left with width", '<div class="border-l-4"></div>', (0, index_js_1.render)((0, index_js_1.Div)().border("left", "4")));
