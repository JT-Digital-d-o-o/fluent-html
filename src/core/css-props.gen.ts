...
// Source: CSSStyleDeclaration in typescript@5.9.3 lib.dom.d.ts (string-typed members,
...
export type CssPropertyName =
  ...
  | "background-position-y" | "background-repeat" | "background-size" | "baseline-shift" | "baseline-source"
  ...
  | "color-interpolation-filters" | "color-scheme" | "column-count" | "column-fill" | "column-gap"
  ...
  | "counter-reset" | "counter-set" | "cursor" | "cx" | "cy" | "d" | "direction" | "display"
  | "dominant-baseline" | "empty-cells" | "fill" | "fill-opacity" | "fill-rule" | "filter" | "flex"
  | "flex-basis" | "flex-direction" | "flex-flow" | "flex-grow" | "flex-shrink" | "flex-wrap" | "float"
  | "flood-color" | "flood-opacity" | "font" | "font-family" | "font-feature-settings" | "font-kerning"
  ...
  | "hyphenate-character" | "hyphenate-limit-chars" | "hyphens" | "image-orientation" | "image-rendering"
  ...
  | "list-style" | "list-style-image" | "list-style-position" | "list-style-type" | "margin" | "margin-block"
  ...
  | "marker-mid" | "marker-start" | "mask" | "mask-clip" | "mask-composite" | "mask-image" | "mask-mode"
  | "mask-origin" | "mask-position" | "mask-repeat" | "mask-size" | "mask-type" | "math-depth" | "math-style"
  | "max-block-size" | "max-height" | "max-inline-size" | "max-width" | "min-block-size" | "min-height"
  | "min-inline-size" | "min-width" | "mix-blend-mode" | "object-fit" | "object-position" | "offset"
  | "offset-anchor" | "offset-distance" | "offset-path" | "offset-position" | "offset-rotate" | "opacity"
  ...
  | "print-color-adjust" | "quotes" | "r" | "resize" | "right" | "rotate" | "row-gap" | "ruby-align"
  | "ruby-position" | "rx" | "ry" | "scale" | "scroll-behavior" | "scroll-margin" | "scroll-margin-block"
  ...
  | "text-anchor" | "text-box" | "text-box-edge" | "text-box-trim" | "text-combine-upright"
  ...
  | "text-emphasis-position" | "text-emphasis-style" | "text-indent" | "text-orientation" | "text-overflow"
  | "text-rendering" | "text-shadow" | "text-transform" | "text-underline-offset" | "text-underline-position"
  | "text-wrap" | "text-wrap-mode" | "text-wrap-style" | "top" | "touch-action" | "transform"
  ...
  | "view-transition-class" | "view-transition-name" | "visibility" | "white-space" | "white-space-collapse"
  | "widows" | "width" | "will-change" | "word-break" | "word-spacing" | "word-wrap" | "writing-mode" | "x"
  | "y" | "z-index" | "zoom" | `--${string}`;
