...
export type { BehaviorEvent, LifecycleEvent, EventBinding } from "./events.js";
export type { BehaviorMap, BehaviorName, BehaviorTarget } from "./map.js";
export type { OptionType } from "./serialize.js";
export { kebab, verbPrefix, optionAttr, decodeOptions } from "./serialize.js";
export type { WireSpec } from "./specs.js";
...
export type { BehaviorSpec, SpecOptions, SpecOptionValue } from "./register.js";
export {
  behaviorRuntimeVersion,
  behaviorStamp,
  behaviorRuntimeFileName,
  behaviorRuntimeSource,
  readAssetStamp,
  assertBehaviorRuntimeAsset,
} from "./runtime-asset.js";
export { buildBehaviorRuntime } from "./build.js";
export type { BuildBehaviorRuntimeOptions, BuiltBehaviorRuntime } from "./build.js";
