...
// Type-only: makes ../core/tag.js part of every program that includes this file,
// so the `declare module` augmentation below resolves even from the DOM-lib
// client build (which never value-imports Tag).
import type {} from "../core/tag.js";
...
export interface BehaviorMap {
  ...
  clipboard: {
    value?: string;
    path?: string;
    feedback?: { target?: BehaviorTarget; mode: "text" | "class"; text?: string; class?: string; durationMs?: number };
  };
  /**
